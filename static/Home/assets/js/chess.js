...
class Chess{
    ...
    constructor(){
        this.ChessBoard = [
            ...
            [new Rook('black', 'a8'), new Knight('black','b8'), new Bishop('black', new Bishop('black', 'c8')), new Queen('black', 'd8'), new King('black', 'e8'), new Bishop('black', 'f8'),new Knight('black','g8'), new Rook('black', 'h8')] //7
          ];
    ...
    clearIndicator(){
        ...
        // Itera sobre todas las imágenes y elimina el evento si está presente
        imgs.forEach((imagen) => {
            imagen.removeEventListener('click', chess_Match.kill_and_move_the_pieces);
          });
    }
    ...
    kill_and_move_the_pieces(piece, move, movements){ // piece is teammate piece //box_div has the div where is enemy piece img
        ...
        if (movements.includes(move)){
            ...
            box_div.removeChild(box_div.querySelector('img'));
